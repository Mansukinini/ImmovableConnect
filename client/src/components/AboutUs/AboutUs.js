            ...
            <div name='aboutUs' className='card-container'>               
                <div className="card">
                    <div className="card-header">
                        ...
                        <div className="card-body">
                            <h5 className="card-title">ACCOUNTABILITY AND GROWTH</h5>
                ...
                <div className="card">
                    <div className="card-header">
                        <img src="../../../public/images/icon.png" alt="..." />
                        <div className="card-body">
                            <h5 className="card-title">TREASURY</h5>
                ...
                <div className="card">
                    <div className="card-header">
                        <img src="../../../public/images/icon.png" alt="..." />
                        <div className="card-body">
                            <h5 className="card-title">EVENTS AND PROGRAM</h5>
                            <p className="card-text">
            ...
            <div className='card-container'>                
                <div className="card">
                    <div className="card-header">
                        <img src="../../../public/images/icon.png" alt="..." />
                        <div className="card-body">
                            <h5 className="card-title">INTERCESSION</h5>
                            <p className="card-text">
                ...
                <div className="card">
                    <div className="card-header">
                        <img src="../../../public/images/icon.png" alt="..." />
                        <div className="card-body">
                            <h5 className="card-title">SECRETARIAL</h5>
                            <p className="card-text">
